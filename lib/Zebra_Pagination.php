...
class Zebra_Pagination
{
    ...
    public function render($return_output = false)
    {
        ...
        $output = '<div class="navigation "><ul class="pagination">';
    ...
    private function _show_next()
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li' . ($this->_properties['page'] == $this->_properties['total_pages'] ? ' class="disabled"' : '') . '><a class="page-link" href="' .
    ...
    private function _show_pages()
    {
        ...
        if ($this->_properties['total_pages'] <= $this->_properties['selectable_pages']) {
            ...
            for (
                ...
                $output .= '<li' . ($this->_properties['page'] == $i ? ' class="active"' : '') . '><a class="page-link" href="' . $this->_build_uri($i) . '">' .
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            $output .= '<li' . ($this->_properties['page'] == ($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) ? ' class="active"' : '') . '><a class="page-link" href="' . $this->_build_uri($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) . '">' .
            ...
            $output .= '<li' . ($this->_properties['page'] == $i ? ' class="active"' : '') . '><a class="page-link" href="' . $this->_build_uri($this->_properties['reverse'] ? 1 : $this->_properties['total_pages']) . '">' .
    ...
    private function _show_previous()
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            $output = '<li' . ($this->_properties['page'] == 1 ? ' class="disabled"' : '') . '><a class="page-link" href="' .
