...
$html = '
    <div style ="text-align:right;position:relative;top:30px; font-size:16px  " >   گزارش    خلاصه بیلانس کل</div>
...
<table border="1"  cellpadding="5">
    <tr>
        <th align="center" style="font-weight:600;background-color:#95ccec;color:#000"  width="100">یورو</th>
        <th align="center" style="font-weight:600;background-color:#95ccec;color:#000"  width="100">کلدار</th>
        <th align="center" style="font-weight:600;background-color:#95ccec;color:#000" width="100">تومان</th>
        <th align="center" style="font-weight:600;background-color:#95ccec;color:#000"  width="100"> دالر</th>
        <th align="center" style="font-weight:600;background-color:#95ccec;color:#000"  width="100"> افغانی</th>
        <th align="center" style="font-weight:600;background-color:#95ccec;color:#000"  width="120">حسابات</th>
